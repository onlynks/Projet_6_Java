 ...
 * 
 */
@WebServiceClient(name = "BookServiceService", targetNamespace = "http://Service.webservice.projet3.com/", wsdlLocation = "http://localhost:8080/BookService/BookServiceService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKSERVICESERVICE_QNAME = new QName("http://Service.webservice.projet3.com/", "BookServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/BookService/BookServiceService?wsdl");
